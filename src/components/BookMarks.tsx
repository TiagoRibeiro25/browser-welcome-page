		...
		<div className="flex flex-row items-center justify-center mt-12">
			{bookmarks.map((bookmark, index) => (
				<a
					key={index}
					href={bookmark.url}
					className="flex items-center justify-center w-16 h-16 m-2 text-3xl text-pink-200 bg-zinc-800 border border-pink-200 rounded-md hover:bg-pink-200 hover:text-zinc-800"
